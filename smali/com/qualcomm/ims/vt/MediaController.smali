...
.method public onDataUsageChanged(IJJ)V
    ...
    invoke-virtual {v3, p1}, Lcom/qualcomm/ims/vt/ImsVideoGlobals;->findVideoCallProviderbyMediaId(I)Lcom/qualcomm/ims/vt/ImsVideoCallProviderImpl;
    ...
    const-string/jumbo v4, "onDataUsageChanged session = "
    ...
    .line 164
    invoke-virtual {v2, v0, v1}, Lcom/qualcomm/ims/vt/ImsVideoCallProviderImpl;->onCallDataUsageChanged(J)V
    ...
    const-string/jumbo v4, "onDataUsageChanged: Call session video provider is null. Received mediaId = "
...
.method public onOrientationModeChanged(I)V
    ...
    .line 83
    :cond_0
    const-string/jumbo v1, "Active call session video provider is null. Can\'t propagate onOrientationModeChanged event"
...
.method public onPlayerStateChanged(I)V
    ...
    const-string/jumbo v3, "onPlayerStateChanged state = "
    ...
    invoke-virtual {v2}, Lcom/qualcomm/ims/vt/ImsVideoGlobals;->getActiveCallVideoProvider()Lcom/qualcomm/ims/vt/ImsVideoCallProviderImpl;
    ...
    .local v0, "status":I
    :goto_0
    invoke-virtual {v1, v0}, Lcom/qualcomm/ims/vt/ImsVideoCallProviderImpl;->handleCallSessionEvent(I)V
    ...
    .line 116
    :cond_1
    const-string/jumbo v2, "Active call session video provider is null. Can\'t propagate onPlayerStateChanged event"
